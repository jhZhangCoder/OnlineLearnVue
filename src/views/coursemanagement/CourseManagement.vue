<template>
    <div class="block" style="overflow:auto;height: 480px;">
        <div
            style="
                font-size: 28px;
                color: grey;
                ...
                <div v-for="t in shduleData" :key="t.id">
                    <el-timeline-item :timestamp="t.createTime" placement="top">
                        <el-card>
                            <div class="cs">
                                <span>
                                    <el-tag type="info">{{ t.senderName }}提问:</el-tag>
                                </span>
                                <span>
                                    <el-tag type="info">问题来源：{{ t.topic }}</el-tag>
                                </span>

                                <span>
                                    <el-tag style="background-color: black;color: white;border: none;">{{ t.recipientName }}回答</el-tag>
                                </span>
                            </div>
                            ...
                            <el-badge :value="count" class="item" style="margin-top: 15px">
                                <el-button type="info" @click="restor(t)">回复</el-button>
                            </el-badge>
                        </el-card>
                    </el-timeline-item>
        ...
        <el-pagination
            ...
            style="text-align: center;margin-left: 40px; margin-top: 80px"
        ></el-pagination>
    </div>
</template>
