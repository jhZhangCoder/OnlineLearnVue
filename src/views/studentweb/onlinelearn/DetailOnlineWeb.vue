                    ...
                    <div>
                        ...
                        <el-form label-width="100px">
                            ...
                            <el-form-item label="上传视频">
                                ...
                                <el-upload style="margin-left:14%;margin-top:5%" class="avatar-uploader el-upload--text"
                                    :drag="{ Plus }" action="http://127.0.0.1:9251/study/videos/save" multiple
                                    :show-file-list="false" :data="addVideoDetail" :on-success="handleVideoSuccess"
