    ...
    <div>
        ...
        >
            <el-table-column
                ...
                width="180"
            ></el-table-column>
            <el-table-column sortable fixed prop="title" label="试题名称"></el-table-column>
            <el-table-column
                sortable
                fixed
                prop="userName"
        ...
        <el-dialog title="已完成情况" :visible.sync="dialogdoTableVisible">
            <el-table :data="Homework" style="width: 100%">
                ...
                <el-table-column prop="replies" label="姓名"></el-table-column>
                <el-table-column label="操作" width="260" fixed="right">
                    <template slot-scope="scope">
                        <el-button @click="handle(scope.$index, scope.row)" type="primary">
                            查看答题情况
                        </el-button>
                    </template>
                </el-table-column>
        ...
        <el-button @click="test()" type="info" class="publish">发布试题</el-button>
